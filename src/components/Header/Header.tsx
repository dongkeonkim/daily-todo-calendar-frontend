...
const Header: React.FC = () => {
  ...
  return (
    <header className='py-4 bg-white dark:bg-gray-800 shadow-md transition-colors duration-300'>
      <div className='container mx-auto px-4 flex justify-between items-center'>
        <div>
          <a
            ...
            onClick={handleClick}
          >
            <div className='h-8 w-8 bg-primary-500 dark:bg-primary-600 rounded-lg flex items-center justify-center'>
              <img
                src={logoImage}
                alt='로고'
                className='h-6 w-6'
            ...
            <h1 className='text-gray-800 dark:text-white font-semibold text-xl'>매일할일</h1>
          </a>
        </div>
